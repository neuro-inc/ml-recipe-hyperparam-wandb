...
| `config/`                            | Configuration files | `storage:ml-recipe-hyper-search/config/`                          | `/ml-recipe-hyper-search/src/` |
| `notebooks/`                         | Jupyter notebooks | `storage:ml-recipe-hyper-search/notebooks/`                         | `/ml-recipe-hyper-search/notebooks/` |
| No directory                         | Logs and results  | `storage:ml-recipe-hyper-search/results/`                           | `/ml-recipe-hyper-search/results/` |
